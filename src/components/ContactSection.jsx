  ...
  return (
    <section id="contact" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Map Section */}
        <div className="mt-16 rounded-2xl overflow-hidden shadow-lg h-96 bg-gray-200">
          {/* In a real application, you would embed a Google Maps or other map provider here */}
          <div className="w-full h-full flex items-center justify-center bg-gray-100">
            <div className="text-center">
              ...
              <p className="text-gray-500">Mohammedia suptech</p>
            </div>
          </div>
        </div>
      </div>
