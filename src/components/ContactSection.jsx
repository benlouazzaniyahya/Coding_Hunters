    ...
    <section id="contact" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1">info@codinghunters.com</p>
                </div>
              </div>
        ...
        <div className="mt-16 rounded-2xl overflow-hidden shadow-lg h-96">
          {/* Google Maps iframe with the specified coordinates */}
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3323.8506931848373!2d-7.408432824759186!3d33.66200167490953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDM5JzQzLjIiTiA3wrAyNCcyMi41Ilc!5e0!3m2!1sen!2sma!4v1622021234567!5m2!1sen!2sma" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen="" 
            ...
            title="Mohammedia Suptech Location"
            aria-label="Map showing Mohammedia Suptech location"
          ></iframe>
        </div>
      </div>
    </section>
